...
meta_og_url: "https://genezio.com/blog/exploring-the-differences-between-genezio-and-express.js"
meta_og_image: "https://genezio.com/images/genezio_express.png"
# meta data end
---
...
With{{< external-link link="https://genezio.com" >}} genezio{{< /external-link >}}
, you will access your functions using the autogenerated SDK provided when you deployed your project or ran it locally. The SDK contains the custom types (enums, classes, unions) you defined in your server code in order to provide a type-safe API. It also takes care of serializing and deserializing your data. You can import this SDK in your client-side project and call the functions just as if they were local functions.{{< external-link link="https://genezio.com" >}} genezio{{< /external-link >}}
...
Advantages of{{< external-link link="https://genezio.com" >}} genezio{{< /external-link >}}
:
